...
public sealed record EmailErrors(string Code, string Message, ErrorType Type) : IError
{
    public static Error EmailIsRequired =>
        new("EmailErrors.EmailIsRequired", "Email é obrigatório", ErrorType.Validation);
    ...
    public static Error EmailIsTooShort =>
        new("EmailErrors.EmailIsTooShort", "Email muito curto", ErrorType.Validation);
}