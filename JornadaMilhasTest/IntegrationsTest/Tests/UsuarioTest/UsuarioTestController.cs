...
public class UsuarioTestController
{
    ...
    {
        var usuario = fixture.Create<UsuarioCadastroDTO>();
        string url = "/usuarios";


        var stringContent = new StringContent(TestHelper.SerializerObjToJson(usuario), encoding: Encoding.UTF8, "application/json");
