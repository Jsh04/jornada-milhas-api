...
public class RegisterDestinyTest
{
    ...
    public void DeverarAparecerModalComDestinoCadastradoComSucesso()
    {
        ...
        var nameDestino = "Atacama";
        var price = "500";
        var subtitle = "O Deserto do Atacama: Onde a Terra Encontra o Infinito";
        ...
        registerDestinyPo
            ...
            .SendKeysInFormDestinyRegister(pathsFiles, nameDestino, subtitle, price, descriptionPortuguese,
                descriptionEnglish)
            .ClickBtnToSendData();

        //assert
        var isModalSucess =
            TestHelper.ReturnValidationOfTimeWait(drv => drv.PageSource.Contains("Destino Cadastrado com sucesso"),
                _driver);
