...
public static class UnitTestHelper
{
    ...
    {
        var customerCreateInputModel = fixture.Build<CustomerCreateInputModel>()
        ...
        var requestUserLimitedRegisterCommand = new RegisterCustomerCommand(customerCreateInputModel);
